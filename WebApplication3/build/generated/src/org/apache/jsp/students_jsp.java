...
public final class students_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 List<User> userList = dblogin.getAllUsers(); 
    ...
    for (User user : userList) {
      ...
      out.write("</div>\r\n");
      out.write("        <form action=\"PrefectServlet\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.print( user.getPasswd() );
      out.write("\">\r\n");
      out.write("            <input type=\"hidden\" name=\"imgg\" value=\"img/");
      out.print( user.getImg() );
      out.write("\">\r\n");
      out.write("            <button class=\"button\" id=\"myButton\" type=\"submit\" value=\"add\" >Prefect</button>\r\n");
      out.write("        </form>\r\n");
      out.write("    </div>\r\n");
      out.write("    ");
 } 
